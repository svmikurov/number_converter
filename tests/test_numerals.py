...
THOUSAND_FACTOR = [
    (13_000, 'F', 'N', 'тринадцать тысяч'),
    (30_000, 'F', 'N', 'тридцать тысяч'),
    (31_000, 'F', 'N', 'тридцать одна тысяча'),
    (32_000, 'F', 'N', 'тридцать две тысячи'),
    (33_000, 'F', 'N', 'тридцать три тысячи'),
    (34_000, 'F', 'N', 'тридцать четыре тысячи'),
    (35_000, 'F', 'N', 'тридцать пять тысяч'),
    (36_000, 'F', 'N', 'тридцать шесть тысяч'),
    (37_000, 'F', 'N', 'тридцать семь тысяч'),
    (38_000, 'F', 'N', 'тридцать восемь тысяч'),
    (39_000, 'F', 'N', 'тридцать девять тысяч'),
    (
        154_323,
        'M',
        'N',
